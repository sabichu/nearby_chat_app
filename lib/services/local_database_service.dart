  ...
  Future<void> _onCreate(Database db, int version) async {
    ...
    await db.execute('''
      CREATE TABLE IF NOT EXISTS messages (
        ...
        message_type TEXT NOT NULL CHECK (message_type IN ('NORMAL', 'ACK', 'ROUTING_UPDATE', 'FULL_UPDATE', 'DISCONNECT_UPDATE', 'REACHABILITY_CHECK', 'REACHABILITY_CHECK_RESPONSE')),
